...
class Pool1:
    def __init__(self, address,token0,token1):
...
class FactoryContrat:
    ...
    def get_all_pools(self,):
        before_len = len(self.list_pool)
        for item in range(before_len , self.pair_length()):
            print(item)
    ...
    def load_data(cls):
        with open("save.json", "r") as file:
            if file is not None:
                ...
                return FactoryContrat(data["factory_contract_address"], fca=data['factory_abi'],pool_list=data['list_pool'])



x = FactoryContrat.load_data()
try:
    x.get_all_pools()
except:
    x.save_data()
